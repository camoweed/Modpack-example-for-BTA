...
Keep in mind unsup uses a launch argument to function, so make sure that remains intact.
- In the /instance/minecraft/ folder edit "source" in ``unsup.ini`` to point at your pack.toml
- You can create your own "branding" icon at this website: https://qoi.y2k.diy/
